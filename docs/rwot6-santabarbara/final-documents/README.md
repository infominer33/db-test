...
_This is a listing for the RWOT6 papers to date. [Several more](../draft-documents/README.md) are in process._

## [*BTCR DID Resolver Specification*](btcr-resolver.pdf) [[md](btcr-resolver.md)] [[odt](btcr-resolver.odt)]
...
## [*Decentralized Autonomic Data (DAD) and the three R's of Key Management*](DecentralizedAutonomicData.pdf) [[md](DecentralizedAutonomicData.md)] [[odt](DecentralizedAutonomicData.odt)]
...
## [*Decentralized Identifiers v1.0*](did-spec-1.0.pdf) [[md](did-spec-1.0.md)] [[odt](did-spec-1.0.odt)]
...
## [*Exploring Sustainable Technology Commons using Appreciative Inquiry*](sustainable-commons.pdf) [[md](sustainable-commons.md)] [[odt](sustainable-commons.odt)]
...
## [*Identity Hub Attestation Flows and Components*](identity-hub-attestations.pdf) [[md](identity-hub-attestations.md)] [[odt](identity-hub-attestations.odt)]
...
## [*Introduction to DID Auth*](did-auth.pdf) [[md](did-auth.md)] [[odt](did-auth.odt)]
...
## [*Open Badges are Verifiable Credentials*](open-badges-are-verifiable-credentials.pdf) [[md](open-badges-are-verifiable-credentials.md)] [[odt](open-badges-are-verifiable-credentials.odt)]
...
## [*SSI: A Roadmap for Adoption*](a-roadmap-for-ssi.pdf) [[md](a-roadmap-for-ssi.md)] [[odt](a-roadmap-for-ssi.odt)]
