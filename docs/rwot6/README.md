...
## [*BTCR DID Resolver Specification*](final-documents/btcr-resolver.pdf) [(Text)](final-documents/btcr-resolver.md)
...
## [*Decentralized Autonomic Data (DAD) and the three R's of Key Management*](final-documents/DecentralizedAutonomicData.pdf) [(Text)](final-documents/DecentralizedAutonomicData.md)
...
## [*Decentralized Identifiers v1.0*](final-documents/did-spec-1.0.pdf) [(Text)](final-documents/did-spec-1.0.md)
#### A Status Note
...
## [*Exploring Sustainable Technology Commons using Appreciative Inquiry*](final-documents/sustainable-commons.pdf) [(Text)](final-documents/sustainable-commons.md)
...
## [*Identity Hub Attestation Flows and Components*](final-documents/identity-hub-attestations.pdf) [(Text)](final-documents/identity-hub-attestations.md)
...
## [*Introduction to DID Auth*](final-documents/did-auth.pdf) [(Text)](final-documents/did-auth.md)
...
## [*Open Badges are Verifiable Credentials*](final-documents/open-badges-are-verifiable-credentials.pdf) [(Text)](final-documents/open-badges-are-verifiable-credentials.md)
...
## [*SSI: A Roadmap for Adoption*](final-documents/a-roadmap-for-ssi.pdf) [(Text)](final-documents/a-roadmap-for-ssi.md)
