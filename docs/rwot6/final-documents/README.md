...
_This is a listing for the RWOT6 papers to date. [Several more](../draft-documents/README) are in process._

## [*BTCR DID Resolver Specification*](btcr-resolver.pdf) [[html](btcr-resolver)] [[odt](btcr-resolver.odt)]
...
## [*Decentralized Autonomic Data (DAD) and the three R's of Key Management*](DecentralizedAutonomicData.pdf) [[html](DecentralizedAutonomicData)] [[odt](DecentralizedAutonomicData.odt)]
...
## [*Decentralized Identifiers v1.0*](did-spec-1.0.pdf) [[html](did-spec-1.0)] [[odt](did-spec-1.0.odt)]
...
## [*Exploring Sustainable Technology Commons using Appreciative Inquiry*](sustainable-commons.pdf) [[html](sustainable-commons)] [[odt](sustainable-commons.odt)]
...
## [*Identity Hub Attestation Flows and Components*](identity-hub-attestations.pdf) [[html](identity-hub-attestations)] [[odt](identity-hub-attestations.odt)]
...
## [*Introduction to DID Auth*](did-auth.pdf) [[html](did-auth)] [[odt](did-auth.odt)]
...
## [*Open Badges are Verifiable Credentials*](open-badges-are-verifiable-credentials.pdf) [[html](open-badges-are-verifiable-credentials)] [[odt](open-badges-are-verifiable-credentials.odt)]
...
## [*SSI: A Roadmap for Adoption*](a-roadmap-for-ssi.pdf) [[html](a-roadmap-for-ssi)] [[odt](a-roadmap-for-ssi.odt)]
